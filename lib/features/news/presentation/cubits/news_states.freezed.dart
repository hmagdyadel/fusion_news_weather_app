...
/// @nodoc
abstract class $NewsStatesCopyWith<T, $Res> {
  factory $NewsStatesCopyWith(
    NewsStates<T> value,
    $Res Function(NewsStates<T>) then,
  ) = _$NewsStatesCopyWithImpl<T, $Res, NewsStates<T>>;
}

/// @nodoc
class _$NewsStatesCopyWithImpl<T, $Res, $Val extends NewsStates<T>>
    implements $NewsStatesCopyWith<T, $Res> {
...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$NewsStatesCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class Initial<T> implements NewsStates<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$NewsStatesCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements NewsStates<T> {
...
class __$$LoadingMoreImplCopyWithImpl<T, $Res>
    extends _$NewsStatesCopyWithImpl<T, $Res, _$LoadingMoreImpl<T>>
...
class _$LoadingMoreImpl<T> implements LoadingMore<T> {
  ...
  @override
  String toString() {
    return 'NewsStates<$T>.loadingMore()';
  }
...
abstract class LoadingMore<T> implements NewsStates<T> {
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<NewsArticleEntity> articles, bool hasMore, bool isOffline});
}

/// @nodoc
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$NewsStatesCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'NewsStates<$T>.success(articles: $articles, hasMore: $hasMore, isOffline: $isOffline)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(articles, hasMore, isOffline);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(articles, hasMore, isOffline);
  }
...
abstract class Success<T> implements NewsStates<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$NewsStatesCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'NewsStates<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements NewsStates<T> {
